...
--
-- Host: localhost:3306
-- Generation Time: Oct 23, 2025 at 10:01 PM
...
CREATE TABLE `about_us` (
  ...
  `toptext` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `year` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descp` text COLLATE utf8mb4_unicode_ci,
  `descp1` text COLLATE utf8mb4_unicode_ci,
  `descp2` text COLLATE utf8mb4_unicode_ci,
  `tprof` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'totalprofessionals',
  `tpsell` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'totalpropertysell',
  `tprent` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'totalpropertyrent',
  `tcust` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'totalcustomers',
...
CREATE TABLE `blog_posts` (
  ...
  `short_descp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `long_descp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `courasels` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `textone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `textwo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `texthree` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `imageone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `properties` (
  ...
  `property_thumbmail` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `site_settings` (
  ...
  `support_phone` text COLLATE utf8mb4_unicode_ci,
