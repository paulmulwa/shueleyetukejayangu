                        ...
                        <div class="author-box pull-left">
                            @if ($property->agent_id == null)
                                <figure class="author-thumb">
                                    <img src="{{ url('uploads/paulo.jpg') }}" alt="">
                                </figure>
                    ...
                    <div class="property-details-content">
                        ...
                        <div class="discription-box content-widget">
                            ...
                            <div class="text">
                                ...
                                <p>
                                    {{-- --------------------------------------------///gettingplaincontenetswithouthtmlcode- ------------------------------------------- --}}
                                    {{ htmlspecialchars(trim(strip_tags($property->long_descp))) }}
                                ...
                                {{-- ////////////////this should be working but replace it with long_descp  or short_descp incase of isues --}}
                            </div>
                        </div>
                        <div class="details-box content-widget">
                            ...
                            <ul class="list clearfix">
                                ...
                                <li>Property Size: <span>{{ $property->property_size }} SQFT</span></li>
                        ...
                        <div class="amenities-box content-widget">
                            ...
                            <ul class="list clearfix">
                                {{-- --//////////////////////////////////////////////////thiamenitiespartrtshpoouldshowupproperly- ---------------------------- --}}
                        ...
                        <div class="location-box content-widget">
                            ...
                            <ul class="info clearfix">
                                ...
                                <li><span>Zip/Postal Code:</span>{{ $property->zip }}</li>
                                <li><span>City:</span> {{ $property->city }}</li>
                            </ul>
                            {{-- ....................................there is an error with displaying of.google maps............................................ --}}
...
@auth
                            ...
                            @else
                            <span class="text-danger">To Chat Login First</span>
                               @endauth
                                {{-- <div class="btn-box"><a href="agents-details.html">View Listing</a></div>
                            </div> --}}
                        </div>
                        ...
                        <div class="form-inner">
                            ...
                            @auth
                                ...
                                <form action="{{ route('property.message')}}" method="post" class="default-form">
                                   @csrf
                <input type="hidden" name="property_id"  value="property_id" value="{{$property->id}}">
                ...
                @foreach ($relatedProperty as $item)
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="{{ asset($item->property_thumbmail) }}"
                                            alt=""></figure>
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        ...
                                        <div class="buy-btn pull-right"><a
                                                href="property-details.html">{{ $item->property_status }}</a></div>
                                    </div>
                                    <div class="title-text">
                                        <h4><a href="property-details.html">{{ $item->city }}</a></h4>
                                    </div>
                                    ...
                                    {{-- </div> --}}
                                    <div class="btn-box"><a
                                            href="{{ url('featuredproperty/details/' . $item->id . '/.' . $item->property_slug) }}"
