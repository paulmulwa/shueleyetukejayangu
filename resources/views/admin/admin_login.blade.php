			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Paulo<span>Laravel</span></a>
...
@csrf
             ...
             {{-- <label for="login" class="form-label">Email/Name/Phone</label>
                      ...
                      <div class="mb-3">
                        <label for="login" class="form-label">Email address/Phone/Username</label>
                        <input type="text" name="login" class="form-control" id="login" placeholder="Email address/Phone/Username">
                      </div>
                      <div class="mb-3">
