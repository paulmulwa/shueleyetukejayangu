  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Paulo</strong>Mulwaaar</h2>
        </td>
        <td align="right">
            <pre class="font" >
               Keja Yangu
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Address:</strong> {{ $packagehistory->user->address }} <br>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        ...
        <td align="center">Ksh {{ $packagehistory->package_amount }}</td>
        <td align="center">Ksh {{ $packagehistory->package_amount }}</td>
