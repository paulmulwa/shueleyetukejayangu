                ...
                <div class="card">
                  <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('agent.profile.store')}}" class="forms-sample" enctype="multipart/form-data">
                                        ...
                                        if($userData == Null){
                                            <span>Established with a passion for connecting people with their ideal properties, we are a leading real estate company committed to delivering unparalleled service and unmatched expertise in the industry</span>

                                            }else{
                                        {{-- //} --}}
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Agent Description</label>
                                            <input type="text" name="agent_descp" value="{{$profileData->agent_descp}}" class="form-control" id="agent_descp" autocomplete="off" placeholder="Agent Description">
                                        </div>
                                    }
                                        <div class="mb-3">
