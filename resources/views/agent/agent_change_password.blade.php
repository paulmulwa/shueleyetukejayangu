            ...
            <div class="row">
                <div class="card">
                  <div class="card-body">
                                    ...
                                    <h6 class="card-title" style="mb-10">agent CHANGE PASSWORD</h6>
                                    ...
                                    class="forms-sample" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3, mt-5">
                                            ...
                                            <input type="passwnew" name="old_password"
                                            ...
                                            <div class="mb-3, mt-2">
                                                ...
                                                <div class="mb-3, mt-2">
                                                    ...
                                                    class="form-control @error ('new_password') is-invalid @enderror" id="new_password_confirmation"
