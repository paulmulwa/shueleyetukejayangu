      ...
      <div class="card-body">
        <div class="container-fluid d-flex justify-content-between">
          ...
          <div class="col-lg-3 pe-0">
            ...
            <h6 class="mb-0 mt-3 text-end fw-normal mb-2"><span class="text-muted">Invoice Date :</span> 24rd Oct 2025</h6>
            <h6 class="text-end fw-normal"><span class="text-muted">Due Date :</span> 25th Oct 2025</h6>
          </div>
        </div>
