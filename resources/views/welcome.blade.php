...
<!-- Stylesheets -->
<link href="{{asset('backend/assets/css/font-awesome-all.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/flaticon.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/owl.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/bootstrap.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/jquery.fancybox.min.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/animate.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/jquery-ui.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/nice-select.css')}}" rel="stylesheet">
<link href="{{asset('backend/assets/css/color/theme-color.css')}}" id="jssDefault" rel="stylesheet">
<link href="{{asset('backend/assets/css/switcher-style.css')}}" rel="stylesheet">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="{{asset('backend/assets/images/logo-light.png')}}" alt=""></a></figure>
                        </div>
            ...
            <div class="sticky-header">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="{{asset('backend/assets/images/logo.png')}}" alt=""></a></figure>
                        </div>
                        <div class="menu-area clearfix">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('backend/assets/images/logo-2.png')}}" alt="" title=""></a></div>
        ...
        <section class="banner-style-two centred">
            <div class="banner-carousel owl-theme owl-carousel owl-nav-none">
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url({{asset('backend/assets/images/banner/banner-2.jpg')}}')}}"></div>
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url({{asset('backend/assets/images/banner/banner-3.jpg')}}')}}"></div>
                    <div class="auto-container">
                        <div class="content-box">
                            <h2>Search Properties for Sale and To Rent</h2>
                            <p>Amet consectetur adipisicing elit sed do eiusmod.</p>
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url({{asset('backend/assets/images/banner/banner-4.jpg')}}')}}"></div>
                    <div class="auto-container">
                        <div class="content-box">
                            <h2>Search Properties for Sale and To Rent</h2>
                            <p>Amet consectetur adipisicing elit sed do eiusmod.</p>
            ...
            <div class="auto-container">
                ...
                <div class="three-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="{{asset('backend/assets/images/feature/feature-1.jpg')}}" alt=""></figure>
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="{{asset('backend/assets/images/feature/author-1.jpg')}}" alt=""></figure>
                                        <h6>Michael Bean</h6>
                                    </div>
                    ...
                    <div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="{{asset('backend/assets/images/feature/feature-2.jpg')}}" alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="{{asset('backend/assets/images/feature/author-2.jpg')}}" alt=""></figure>
                                        <h6>Robert Niro</h6>
                                    </div>
                    ...
                    <div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="{{asset('backend/assets/images/feature/feature-3.jpg')}}" alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="{{asset('backend/assets/images/feature/author-3.jpg')}}" alt=""></figure>
                                        <h6>Keira Mel</h6>
                                    </div>
        ...
        <!-- cta-section -->
        <section class="cta-section alternate-2 centred" style="background-image: url({{asset('backend/assets/images/background/cta-1.jpg')}});">
            <div class="auto-container">
                    ...
                    <div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="{{asset('backend/assets/images/resource/deals-2.jpg')}}" alt=""></figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="{{asset('backend/assets/images/feature/author-1.jpg')}}" alt="">
                                    ...
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="{{asset('backend/assets/images/feature/author-2.jpg')}}" alt="">
                                    ...
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="{{asset('backend/assets/images/feature/author-3.jpg')}}" alt="">
                                                        <span>Keira Mel</span>
                                                    </figure>
                                                </div>
                                            </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{asset('backend/assets/images/team/team-6.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{asset('backend/assets/images/team/team-7.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{asset('backend/assets/images/team/team-8.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
        ...
        <section class="testimonial-style-two" style="background-image: url({{asset('backend/assets/images/background/testimonial-1.jpg')}});">
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme dots-style-one owl-nav-none">
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img src="{{asset('backend/assets/images/resource/testimonial-1.jpg')}}" alt=""></figure>
                                        <h4>Rebeka Dawson</h4>
                            ...
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img src="{{asset('backend/assets/images/resource/testimonial-2.jpg')}}" alt=""></figure>
                                        <h4>Marc Kenneth</h4>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_1">
                            <div class="image-box">
                                <figure class="image image-1 paroller"><img src="{{asset('backend/assets/images/resource/place-5.jpg')}}" alt=""></figure>
                                <figure class="image image-2 paroller-2"><img src="{{asset('backend/assets/images/resource/place-6.jpg')}}" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="clients-section bg-color-1">
            <div class="pattern-layer" style="background-image: url({{asset('backend/assets/images/shape/shape-1.png')}});"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 inner-column">
                        <div class="clients-logo">
                            <ul class="logo-list clearfix">
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('backend/assets/images/clients/clients-1.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('backend/assets/images/clients/clients-2.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('backend/assets/images/clients/clients-3.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('backend/assets/images/clients/clients-4.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('backend/assets/images/clients/clients-5.png')}}" alt=""></a></figure>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="blog-details.html"><img src="{{asset('backend/assets/images/news/news-1.jpg')}}" alt=""></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="{{asset('backend/assets/images/news/author-1.jpg')}}" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="blog-details.html"><img src="{{asset('backend/assets/images/news/news-2.jpg')}}" alt=""></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="{{asset('backend/assets/images/news/author-2.jpg')}}" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="blog-details.html"><img src="{{asset('backend/assets/images/news/news-3.jpg')}}" alt=""></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="{{asset('backend/assets/images/news/author-3.jpg')}}" alt=""></figure>
        ...
        <section class="subscribe-section bg-color-3">
            <div class="pattern-layer" style="background-image: url({{asset('backend/assets/images/shape/shape-2.png')}});"></div>
            <div class="auto-container">
                <div class="row clearfix">
        ...
        <footer class="main-footer">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img src="{{asset('backend/assets/images/resource/footer-post-1.jpg')}}" alt=""></a></figure>
                                        <h5><a href="blog-details.html">The Added Value Social Worker</a></h5>
                                        <p>Mar 25, 2020</p>
                                    </div>
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img src="{{asset('backend/assets/images/resource/footer-post-2.jpg')}}" alt=""></a></figure>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        <figure class="footer-logo"><a href="index.html"><img src="{{asset('backend/assets/images/footer-logo.png')}}" alt=""></a></figure>
    ...
    <script src="{{asset('backend/assets/js/wow.js')}}"></script>
    <script src="{{asset('backend/assets/js/validation.js')}}"></script>
    <script src="{{asset('backend/assets/js/jquery.fancybox.js')}}"></script>
    <script src="{{asset('backend/assets/js/appear.js')}}"></script>
    <script src="{{asset('backend/assets/js/scrollbar.js')}}"></script>
    <script src="{{asset('backend/assets/js/isotope.js')}}"></script>
    <script src="{{asset('backend/assets/js/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('backend/assets/js/jQuery.style.switcher.min.js')}}"></script>
    <script src="{{asset('backend/assets/js/jquery-ui.js')}}"></script>
    <script src="{{asset('backend/assets/js/jquery.paroller.min.js')}}"></script>
    <script src="{{asset('backend/assets/js/nav-tool.js')}}"></script>
