        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="{{asset('frontend/assets/images/logo-light.png')}}" alt=""></a></figure>
                        </div>
        ...
        <section class="banner-style-two centred">
            <div class="banner-carousel owl-theme owl-carousel owl-nav-none">
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url({{ asset('frontend/assets/images/banner/banner-2.jpg')}}')}}"></div>
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url({{asset('frontend/assets/images/banner/banner-3.jpg')}}')}}"></div>
                    <div class="auto-container">
                        <div class="content-box">
                            <h2>Search Properties for Sale and To Rent</h2>
                            <p>Amet consectetur adipisicing elit sed do eiusmod.</p>
                    ...
                    <div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="{{asset('frontend/assets/images/resource/deals-2.jpg')}}" alt=""></figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-6.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-7.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset('frontend/assets/images/team/team-8.jpg')}}" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme dots-style-one owl-nav-none">
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img src="{{asset('frontend/assets/images/resource/testimonial-1.jpg')}}" alt=""></figure>
                                        <h4>Rebeka Dawson</h4>
                            ...
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img src="{{ asset('frontend/assets/images/resource/testimonial-2.jpg')}}" alt=""></figure>
                                        <h4>Marc Kenneth</h4>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_1">
                            <div class="image-box">
                                <figure class="image image-1 paroller"><img src="{{ asset('frontend/assets/images/resource/place-5.jpg')}}" alt=""></figure>
                                <figure class="image image-2 paroller-2"><img src="{{ asset('frontend/assets/images/resource/place-6.jpg')}}" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 inner-column">
                        <div class="clients-logo">
                            <ul class="logo-list clearfix">
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('frontend/assets/images/clients/clients-1.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('frontend/assets/images/clients/clients-2.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('frontend/assets/images/clients/clients-3.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('frontend/assets/images/clients/clients-4.png')}}" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="{{asset('frontend/assets/images/clients/clients-5.png')}}" alt=""></a></figure>
                                </li>
                            </ul>
                        </div>
                    </div>
